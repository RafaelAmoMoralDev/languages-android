...
import learning.rafaamo.languages.data.datasource.remote.ConversationAPI
...
class ConversationRepository @Inject constructor(
  ...
  suspend fun update(conversation: learning.rafaamo.languages.ui.view.content.conversation.bottom_sheet.Conversation): Resource<Unit, Unit> {
